...
export const Providers = {
    ...
    'getInitializationProvider()' : {
      description : 'Initialize custom object',
      text : 'InitializationProvider',
      url : developer_site_url + "on-initialize-object",
      fns : {
        'applyTargetChanges()' : {
          description : 'Apply changes to initialization provider - does not persist',
          params : [],
          return : 'void'
        }
      }
